/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: af4f91ba08dc3460ee3459e4c07c4e10)
// Runtime types generated with workerd@1.20260426.1 2025-12-01 disable_nodejs_process_v2,global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface CapstoneEnv {
		SESSION_CACHE: KVNamespace;
		PORTAL_DB: D1Database;
		ASSETS: Fetcher;
		GITHUB_CLIENT_ID: "Ov23li8R7jigMPatjOml";
		...
		PUBLIC_SITE_URL: "https://ywcc-capstone.js426.workers.dev";
		PUBLIC_TURNSTILE_SITE_KEY: "0x4AAAAAACf0yCNwVePpAiMn";
		RESEND_FROM_EMAIL: "YWCC Capstone <noreply@intraphase.com>";
		...
		RATE_LIMITER: DurableObjectNamespace /* SlidingWindowRateLimiter from rate-limiter-worker */;
	}
	interface RwcUsEnv {
		ASSETS: Fetcher;
		PUBLIC_GTM_ID: "GTM-NS9N926Q";
		PUBLIC_SANITY_DATASET: "rwc";
		PUBLIC_SANITY_STUDIO_DATASET: "rwc";
		PUBLIC_SANITY_STUDIO_PROJECT_ID: "49nk9b0w";
		PUBLIC_SANITY_STUDIO_URL: "https://ywcccapstone.sanity.studio";
		PUBLIC_SANITY_VISUAL_EDITING_ENABLED: "false";
		PUBLIC_SITE_ID: "rwc-us";
		PUBLIC_SITE_THEME: "blue";
		PUBLIC_SITE_URL: "https://rwc-us.js426.workers.dev";
		PUBLIC_TURNSTILE_SITE_KEY: "0x4AAAAAACf0yCNwVePpAiMn";
		TURNSTILE_SECRET_KEY: string;
		DISCORD_WEBHOOK_URL: string;
		SANITY_API_WRITE_TOKEN: string;
	...
	interface RwcIntlEnv {
		...
		PUBLIC_SITE_URL: "https://rwc-intl.js426.workers.dev";
		PUBLIC_TURNSTILE_SITE_KEY: "0x4AAAAAACf0yCNwVePpAiMn";
		TURNSTILE_SECRET_KEY: string;
		DISCORD_WEBHOOK_URL: string;
		SANITY_API_WRITE_TOKEN: string;
	...
	interface CapstonePreviewEnv {
		ASSETS: Fetcher;
		GITHUB_CLIENT_ID: "Ov23liFtOiWIyCqJXJMi";
		PUBLIC_GTM_ID: "";
		PUBLIC_SANITY_DATASET: "production";
		PUBLIC_SANITY_STUDIO_DATASET: "production";
		PUBLIC_SANITY_STUDIO_PROJECT_ID: "49nk9b0w";
		...
		PUBLIC_SITE_ID: "capstone";
		PUBLIC_SITE_THEME: "red";
		PUBLIC_SITE_URL: "https://ywcc-capstone-preview.js426.workers.dev";
		PUBLIC_TURNSTILE_SITE_KEY: "0x4AAAAAACf0yCNwVePpAiMn";
		RESEND_FROM_EMAIL: "YWCC Capstone <noreply@intraphase.com>";
		TURNSTILE_SECRET_KEY: string;
		DISCORD_WEBHOOK_URL: string;
	...
	interface RwcUsPreviewEnv {
		...
		PUBLIC_SITE_ID: "rwc-us";
		PUBLIC_SITE_THEME: "blue";
		PUBLIC_SITE_URL: "https://rwc-us-preview.js426.workers.dev";
		PUBLIC_TURNSTILE_SITE_KEY: "0x4AAAAAACf0yCNwVePpAiMn";
		TURNSTILE_SECRET_KEY: string;
		DISCORD_WEBHOOK_URL: string;
		SANITY_API_WRITE_TOKEN: string;
	...
	interface RwcIntlPreviewEnv {
		...
		PUBLIC_SITE_ID: "rwc-intl";
		PUBLIC_SITE_THEME: "green";
		PUBLIC_SITE_URL: "https://rwc-intl-preview.js426.workers.dev";
		PUBLIC_TURNSTILE_SITE_KEY: "0x4AAAAAACf0yCNwVePpAiMn";
		TURNSTILE_SECRET_KEY: string;
		DISCORD_WEBHOOK_URL: string;
		SANITY_API_WRITE_TOKEN: string;
	...
	interface Env {
		...
		PORTAL_DB?: D1Database;
		ASSETS: Fetcher;
		GITHUB_CLIENT_ID?: "Ov23li8R7jigMPatjOml" | "Ov23liFtOiWIyCqJXJMi";
		PUBLIC_GTM_ID?: "GTM-NS9N926Q" | "";
		PUBLIC_SANITY_DATASET?: "production" | "rwc";
		PUBLIC_SANITY_STUDIO_DATASET?: "production" | "rwc";
		PUBLIC_SANITY_STUDIO_PROJECT_ID?: "49nk9b0w";
		PUBLIC_SANITY_STUDIO_URL?: "https://ywcccapstone.sanity.studio";
		PUBLIC_SANITY_VISUAL_EDITING_ENABLED?: "false" | "true";
		PUBLIC_SITE_ID?: "capstone" | "rwc-us" | "rwc-intl";
		PUBLIC_SITE_THEME?: "red" | "blue" | "green";
		PUBLIC_SITE_URL?: "https://ywcc-capstone.js426.workers.dev" | "https://rwc-us.js426.workers.dev" | "https://rwc-intl.js426.workers.dev" | "https://ywcc-capstone-preview.js426.workers.dev" | "https://rwc-us-preview.js426.workers.dev" | "https://rwc-intl-preview.js426.workers.dev";
		PUBLIC_TURNSTILE_SITE_KEY?: "0x4AAAAAACf0yCNwVePpAiMn";
		RESEND_FROM_EMAIL?: "YWCC Capstone <noreply@intraphase.com>";
		TURNSTILE_SECRET_KEY: string;
		DISCORD_WEBHOOK_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_CLIENT_ID" | "PUBLIC_GTM_ID" | "PUBLIC_SANITY_DATASET" | "PUBLIC_SANITY_STUDIO_DATASET" | "PUBLIC_SANITY_STUDIO_PROJECT_ID" | "PUBLIC_SANITY_STUDIO_URL" | "PUBLIC_SANITY_VISUAL_EDITING_ENABLED" | "PUBLIC_SITE_ID" | "PUBLIC_SITE_THEME" | "PUBLIC_SITE_URL" | "PUBLIC_TURNSTILE_SITE_KEY" | "RESEND_FROM_EMAIL" | "TURNSTILE_SECRET_KEY" | "DISCORD_WEBHOOK_URL" | "SANITY_API_WRITE_TOKEN" | "SANITY_API_READ_TOKEN" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "STUDIO_ADMIN_TOKEN" | "STUDIO_ORIGIN">> {}
}
