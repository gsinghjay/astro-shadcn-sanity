...
export type GalleryImage = {
  ...
  featured?: boolean;
  year?: number;
  category?: "web-apps" | "mobile" | "ai-ml" | "data-viz" | "iot" | "other";
};
...
// Query: *[_type == "sponsor" && hidden != true && ($site == "" || site == $site)] | order(name asc){  _id, name, "slug": slug.current,  logo{ asset->{ _id, url, metadata { lqip, dimensions } }, alt, hotspot, crop },  logoSquare{ asset->{ _id, url, metadata { lqip, dimensions } }, alt },  logoHorizontal{ asset->{ _id, url, metadata { lqip, dimensions } }, alt },  tier, description, website, featured}
...
// Query: *[_type == "sponsor" && slug.current == $slug && ($site == "" || site == $site)][0]{  _id, name, "slug": slug.current,  logo{ asset->{ _id, url, metadata { lqip, dimensions } }, alt, hotspot, crop },  logoSquare{ asset->{ _id, url, metadata { lqip, dimensions } }, alt },  logoHorizontal{ asset->{ _id, url, metadata { lqip, dimensions } }, alt },  tier, description, website, featured, industry,  seo { metaTitle, metaDescription, noIndex, ogImage { asset->{ _id, url, metadata { lqip, dimensions } }, alt } },  "projects": *[_type == "project" && references(^._id) && ($site == "" || site == $site)]{ _id, title, "slug": slug.current }}
...
// Query: *[_type == "project" && ($site == "" || site == $site)] | order(title asc){  _id, _createdAt, title, "slug": slug.current,  content,  sponsor->{ _id, name, "slug": slug.current, logo{ asset->{ _id, url, metadata { lqip, dimensions } }, alt, hotspot, crop }, industry, hidden },  technologyTags,  semester,  status,  outcome,  featured}
...
export type LISTING_PAGE_QUERY_RESULT = {
  ...
  headerBlocks: Array<
    ...
    | {
        ...
        verticalAlign: "center" | "stretch" | "top" | null;
      }
    | {
        _type: "comparisonTable";
        _key: string;
