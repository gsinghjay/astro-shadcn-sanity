...
class WorkerSettings(BaseModel):
    ...
    sanity_dataset_capstone: str | None = None
    sanity_dataset_rwc: str | None = None
    ...
    def env_vars(self) -> dict[str, str]:
        ...
        return {
            ...
            "sanity_dataset_capstone": self.sanity_dataset_capstone,
            "sanity_dataset_rwc": self.sanity_dataset_rwc
        }
    ...
    def from_worker_env(cls, env) -> "WorkerSettings":
        ...
        return cls(
            ...
            sanity_dataset_capstone=_get("SANITY_DATASET_CAPSTONE"),
            sanity_dataset_rwc=_get("SANITY_DATASET_RWC"),
            # Secrets
